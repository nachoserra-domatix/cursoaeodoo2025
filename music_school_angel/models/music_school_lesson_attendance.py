...
class MusicSchoolLessonAttendance(models.Model):
    ...
    #En versions anteriors de odoo.
    #_order = 'sequence' o _order = 'name asc'

    sequence = fields.Integer('Sequence', default=10, help="Sequence for ordering attendance records")
