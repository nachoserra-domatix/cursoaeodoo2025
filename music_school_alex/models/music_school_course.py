...
'''
    Este módulo define el modelo 'music.school.course' para gestionar los cursos de la escuela de música.
    Incluye campos para almacenar información sobre el curso, como nombre, descripción, estado, 
    docente, instrumento, nivel, fechas de inicio y fin, capacidad, y mapeo de estudiantes. 
    Además, agregamos métodos para calcular el número de lecciones y exámenes asociados, 
    así como para sincronizar y gestionar el estado de los cursos (borrador, en progreso, finalizado).
    También permite la creación de lecciones y la asignación de estudiantes a los cursos.
'''
...
class MusicSchoolCourse(models.Model):
    ...
    active = fields.Boolean(
        string="Active",
        default=True,
        help="Indicates whether the course is active"
    )
